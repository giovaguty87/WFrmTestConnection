...
La solucion de informacion personal consta de dos proyectos asi:
...
App.config en el cual esta la cadena de conexion que se utiliza desde el proyecto numero dos (2).
